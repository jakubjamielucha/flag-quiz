        ...
        imageViewNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (buttonControl && question < 10)
                {
                    ...
                    buttonA.setBackgroundColor(getResources().getColor(R.color.gold_700, getTheme()));
                    buttonB.setBackgroundColor(getResources().getColor(R.color.gold_700, getTheme()));
                    buttonC.setBackgroundColor(getResources().getColor(R.color.gold_700, getTheme()));
                    buttonD.setBackgroundColor(getResources().getColor(R.color.gold_700, getTheme()));
                }
                else if (question == 10)
                {
                    if(!buttonControl){
